...
postprocess_params = {
    ...
    # "character_dict_path": "./data/china.txt",
            ...
            for idx in range(len(text_index[batch_idx])):
                ...
                if is_remove_duplicate:
                    ...
                    if idx > 0 and text_index[batch_idx][idx - 1] == text_index[batch_idx][idx]:
                        continue
                # if text_index[batch_idx][idx] > 94:
                #     print(text_index[batch_idx][idx])
                loc = 94 if text_index[batch_idx][idx] > 94 else text_index[batch_idx][idx]
                char_list.append(self.character[loc])
...
def draw_box_txt_fine(img_size, box, txt, font_path="./data/latin.ttf"):
    box_height = int(
...
def create_font(txt, sz, font_path="./data/latin.ttf"):
